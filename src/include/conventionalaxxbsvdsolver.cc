...
Pose ConventionalAXXBSVDSolver::SolveX()
{
  ...
  // std::cout <<"m(ConventionalAXXBSVDSolver) =" << m<< "\n";
  ...
  std::cout <<"R===(ConventionalAXXBSVDSolver) =" << R<< "\n";
  ...
  // std::cout <<"m(ConventionalAXXBSVDSolver) =" << m<< "\n";
  std::cout <<"Rx(ConventionalAXXBSVDSolver) =" << handeyetransformation.topLeftCorner(3,3)<< "\n";
