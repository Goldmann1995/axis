...
Pose ExtendedAXXBEliLambdaSVDSolver::SolveX()
{
  ...
  // std::cout <<"m(ExtendedAXXBEliLambdaSVDSolver) =" << m<< "\n";
  ...
  std::cout <<"Rwithscale =" << Rwithscale<< "\n";
  ...
  std::cout <<"Rx(ExtendedAXXBEliLambdaSVDSolver) =" << handeyetransformation.topLeftCorner(3,3)<< "\n";
